...
describe('BcJettonMinter', () => {
            ...
            BcJettonMinter.createFromConfig(
                {
                    ...
                    maxTon: toNano(1500000000000000000000),
    ...
    it('should sell', async () => {
        ...
        const commonSenderBalanceBeforeSell = await commonSender.getBalance();
        ...
        const commonSenderBalanceAfterSell = await commonSender.getBalance();
        expect(commonSenderBalanceBeforeSell).toBeLessThan(commonSenderBalanceAfterSell);
    });
